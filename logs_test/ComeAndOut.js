...
var roomid ='A8374845B30909709C33DC5901307461';
...
function sessionid(callback) {
    ...
    console.log('tester' + num.toString() + newDate.toLocaleString());
    http.get('http://view.csslcloud.net/api/room/login?roomid='+ roomid + '&userid=99BB96FA148B8FAB&viewername=tester'+ num.toString(), function (response) {
    var body = [];
    var key = "";
...
function getSessionid(res) {
    ...
    setTimeout(function () {
        ...
        //timeout2 = Math.round(Math.random()*100000+100000);
